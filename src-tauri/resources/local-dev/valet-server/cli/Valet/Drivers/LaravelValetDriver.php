...
/**
 * Laravel application driver (public/index.php + artisan).
 *
 * Adapted from Laravel Valet (MIT). Herd-specific inject hooks removed;
 * Symfony Process dependency removed (not needed for request serving).
 */
